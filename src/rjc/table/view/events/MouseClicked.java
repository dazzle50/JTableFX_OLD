...
public class MouseClicked implements EventHandler<MouseEvent>
{
  ...
  public void handle( MouseEvent event )
  {
    ...
    TableAxis cAxis = view.getColumnsAxis();
    TableAxis rAxis = view.getRowsAxis();
    CellPosition focus = view.getFocusCell();
    ...
    {
      int columnIndex = cAxis.getIndexFromPosition( focus.getColumnPos() );
      int rowIndex = rAxis.getIndexFromPosition( focus.getRowPos() );
      view.openEditor( view.getData().getValue( columnIndex, rowIndex ) );
    }
